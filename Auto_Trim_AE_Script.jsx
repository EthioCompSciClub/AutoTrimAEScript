...
var threshold = 1; //threshold is used to estimate the decibel of audio to be trimmed 
...
pad.size = [60, 25]; //this value is for the gui window that appears at the start of the program
